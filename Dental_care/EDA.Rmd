...
ggplot(DT[Country != "Switzerland"], aes(Country, `2008`)) +
  ...
  labs(title = "Dental care 2008-2019", subtitle = "Per Capita (Euros)", caption = "Source:Manon") +ylim(c(0,450))+
  coord_flip() +
 
 
  scale_color_manual(values=cols)+ theme_fivethirtyeight()+ ylab("%")+ theme(axis.text.y = element_text(size=8)) 
```
