...
ggplot(df2,aes(x=Steuerfinanzierte.Gesundheitsausgaben,y=Ausgaben.von.Pflichtkrankenversicherungen,label=CODE))+  geom_text(check_overlap = TRUE,size=4,color="#7a0177")+labs(x='Steuerfinanzierte Gesundheitsausgaben',y='Ausgaben von Pflichtkrankenversicherungen')
