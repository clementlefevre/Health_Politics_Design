...
title1<- c("Gesundheitsausgaben pro Kopf in US $","$US")
title2<- c("Öffentliche Gesundheitsausgaben als Anteil der Gesamtgesundheitsausgaben","%")
...
```
```{r}
ggplot(data=gato ,aes(x=year,y=expenditure,colour=(Country.Name)))+ geom_line(size=1)+labs(colour="")+  
```
